...
EMAIL_RECIPIENTS = os.getenv('MC_EMAIL_RECIPIENTS').split(',') if os.getenv('MC_EMAIL_RECIPIENTS') else ["another@user.com"]

VERIFY_REQUESTS = True

MINIMUM_FILE_SIZE = os.getenv('MC_MINIMUM_FILE_SIZE', 10000000)
